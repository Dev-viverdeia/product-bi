...
- `AppRail` (`app-rail.tsx`) — rail vertical branco, ícone **+ rótulo**, agrupado por `GRUPOS_DE_NAV`, ferramentas no rodapé. Item ativo é pílula preenchida (`bg-primary`), não fundo mais claro: sobre o cromo branco a diferença de alfa que funcionava na barra navy é quase invisível.
