...
export function ExplorarPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/*
        SEM `SecaoDeAnalise`. Ela põe os filhos dentro de um `BentoGrid` de 12
        colunas, e este layout de índice + tabela é um `<div>` cru — que ali
        vira item de UMA coluna a partir de `md`, espremendo a tela inteira numa
        tira. No celular passava despercebido; no desktop desmontava.

        E a seção seria cerimônia mesmo se coubesse: a régua desta tela já vem
        do `CabecalhoDeModulo`, e não há duas perguntas para agrupar aqui.
      */}
